        ...
        <el-row>
            ...
            <div class="textBox">
              ...
              <div style="float: left;line-height: 45px;margin-left: 20px;">
                <p style="font-size: 45px;">
                  {{ jobNum }}<span style="font-size: 28px;font-weight: bold;">&ensp;人</span>
                </p>
          ...
          <div class="box" style="background-color: #b48dd3;">
            <div class="textBox">
              ...
              <div style="float: left;line-height: 45px;margin-left: 20px;">
                <p style="font-size: 45px;">
                  {{ jobList.length }}<span style="font-size: 28px;font-weight: bold;">&ensp;份</span>
                </p>
                <p style="font-size: 20px;margin-left: 5px; ">收到简历</p>
              </div>
        ...
        <el-row>
          <div class="box" style="background-color: #68e365;">
            <div class="textBox">
              ...
              <div style="float: left;line-height: 45px;margin-left: 20px;">
                <p style="font-size: 45px;">
                  {{ jobNum }}<span style="font-size: 28px;font-weight: bold;">&ensp;个</span>
                </p>
                <p style="font-size: 20px;margin-left: 5px; ">正在招聘（岗位）</p>
              </div>
          ...
          <div class="box" style="background-color: #5dcfc6;">
            <div class="textBox">
              ...
              <div style="float: left;line-height: 45px;margin-left: 20px;">
                <p style="font-size: 45px;">
                  {{ successList.length }}<span style="font-size: 28px;font-weight: bold;">&ensp;份数</span>
                </p>
                <p style="font-size: 20px;margin-left: 5px; ">简历通过</p>
              </div>
  ...
  mounted() {
    ...
    this.request.get("/user/" + this.userInfo.id).then(res => {
      ...
      this.request.get("/job" ).then(res => {
        this.jobList = res.data.filter(item => {
          return item.companyId === this.companyId.toString()
        })
        ...
        this.idList.forEach(item => {
          this.request.get("/accept/" + item).then(res => {
            res.data.forEach(el => {
              this.acceptList.push(el)
            })
            // console.log(this.acceptList)
            
            this.successList = this.acceptList.filter(e => e.accept === "1")
    ...
    this.request.get("/accept").then(res => {
      ...
      // this.setData(this.form, this.Data)
